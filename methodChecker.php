...
if(strpos($exploded_answer[0], 'public static boolean') !==false){
                               $decoded_json[$object_number]['returnType'] = 'bolean';
...
if($param_flag == true){ $score_tally = $score_tally - 3; }else {$local_points = $local_points + 3; $response = $response . ' Parameters matched. ';}
/*
$intreturn = ' int ';
$stringreturn = ' String ';
$voidreturn = ' void ';
...
if($errorFlag == true){
$method_header = $method_header . ' ' . $decoded_json[$object_number]['returnType'] .' '. $decoded_json[$object_number]['methodName'] . $generated_params_header;
